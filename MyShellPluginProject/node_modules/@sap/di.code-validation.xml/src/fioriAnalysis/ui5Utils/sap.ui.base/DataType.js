...
var library = require("../sap.ui.core/library");
var core;
(function() {//jQuery
	"use strict";
	/**
	...
	(function() {
		...
		DataType.getObject = function(sTypeName) {
			if (!core) {
				core = library(this);
			}
			if (sTypeName.indexOf("sap.ui.core.") === 0) {
				return core[sTypeName.replace("sap.ui.core.", "")];
			}
		};
		...
		DataType.getType = function(sTypeName) {
			...
			if ( !oType ) {
				...
				if (sTypeName.indexOf("[]") > 0) {
					...
					oType = this.getObject(sTypeName);
					/*if (!oType) {
						oType = createType(sTypeName);
					}*/
