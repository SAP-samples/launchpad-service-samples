...
declare namespace sap {
  ...
  namespace f {
    ...
    namespace dnd {
      ...
      interface GridDropInfoOpts extends sap.ui.core.dnd.DropInfoOpts {
        /**
    ...
    interface GridListItemOpts extends sap.m.ListItemBaseOpts {
      /**
